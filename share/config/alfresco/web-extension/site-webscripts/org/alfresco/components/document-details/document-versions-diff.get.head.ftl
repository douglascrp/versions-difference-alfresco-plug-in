 ...
 *  File    document-versions-diff.get.head.ftl
 **/
-->
<!-- Document Versions Custom -->
<@script type="text/javascript" src="${page.url.context}/res/components/document-details/document-versions-diff-custom.js"></@script>
<@link rel="stylesheet" type="text/css" href="${page.url.context}/res/components/document-details/document-versions-diff-custom.css" />
<!-- Revert Version -->
